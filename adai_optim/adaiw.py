'''
The Pytorch Implementation of Adaptive Inertia Estimation with decoupled weight decay (AdaiW).
...
class AdaiW(Optimizer):
    r"""Implements Adai with with decoupled weight decay (AdaiW).
    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            ...
            for p in group['params']:
                ...
                # Perform the decoupled weight decay
